...
const LOCALES: { code: Locale; labelKey: string; switchKey: string }[] = [
  {
    code: "en-CA",
    labelKey: "localeSwitcher.en",
    switchKey: "localeSwitcher.switchToEn",
  },
  {
    // fr-CA isn't in the Locale union yet; cast for forward-compat with future locale support.
    code: "fr-CA" as Locale,
    labelKey: "localeSwitcher.fr",
    switchKey: "localeSwitcher.switchToFr",
  },
];
